...
QT_MOC_LITERAL(3, 31, 4) // "data"
    ...
    "data_processor\0ValidDataReady\0\0data"
};
...
void data_processor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ValidDataReady((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (data_processor::*)(QByteArray );
...
// SIGNAL 0
void data_processor::ValidDataReady(QByteArray _t1)
{
